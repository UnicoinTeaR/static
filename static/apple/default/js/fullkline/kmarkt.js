...
//						 str += '<li>' + util.numFormat(_temp.fsuccessamount,markt.fixedNum) +'</li>';
                    ...
                    if('未完成' == _temp.fstatus_s){
                        str += '<li class="color_ff3c3c">' + language["apple.dom.msg4"] + '</li>';
                    }else if('部分完成' == _temp.fstatus_s){
                        str += '<li>' + language["apple.dom.msg5"] + '</li>';
                    }else if('完全完成' == _temp.fstatus_s){
                        str += '<li class="color_00bb5a">' + language["apple.dom.msg6"] + '</li>';
                    }else{
                        str += '<li>' + _temp.fstatus_s + '</li>';
                    }
                    str += '<li>' + markt.entrustSource(_temp.fsource) + '</li>';
                    if(_temp.fstatus == 1 || _temp.fstatus== 2) {
                        str += '<li data-value="'+ _temp.fid + '"><a href="javascript:;" style="color:#666666">'+language["apple.dom.msg7"]+'</a></li>';
                    } else {
                        str += '<li></li>';
                    }
                    str += '</ul>';
