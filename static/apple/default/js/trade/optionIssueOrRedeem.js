...
var trade = {
    ...
    initOptionWallet: function () {
        $.ajax({
            type: 'post',
            url: "/option/getOptionWalletExchangeBySymbol?" + Math.round(Math.random() * 100),
            dataType: 'json',
            data: {
                symbol: $("#fcode").val(),
            },
...
//            url: "/n/getCurrentEntrust.html",
            url: "/option/getIssueOrRedeem.html",
            dataType: 'json',
            data: param,
            success: function (data) {
            	if (data.code) {
