...
var simpleAlert = function (opts) {
    ...
    var $simpleAlertBody = $('<div class="simpleAlertBody container">');
    var $simpleAlertBodyClose = $('<i class="simpleAlertBodyClose icon iconfont icon-cuo"></i>');
    var $simpleAlertBodyContent = $('<div class="simpleAlertBodyContent">' + option.content + '</div>');
    dialog.init = function () {
        ...
        $simpleAlertBody.show().animate({"marginTop":"-20%","opacity":"1"},300);
    }
    //右上角关闭按键事件
