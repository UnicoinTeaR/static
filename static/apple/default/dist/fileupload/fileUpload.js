...
var uploadTools = {
    ...
    "initWithLayout":function(opt){
        ...
        if(opt.titleInfo){
        	btsStr +="<div class='p_center'>"+opt.titleInfo+"</div>";
        }
        $("#"+uploadId).append(boxStr);
        btsStr += "<div class='uploadBts'>";
        btsStr += "<div class='uploadBtsbox'>";
        btsStr += "<a class='selectFileBt btn btn-primary btn-sm'>选择文件</a>";
        btsStr += "</div>";
        btsStr += "<div class='cleanFileBt'>";
        btsStr += "<a class='deleteFileBt btn btn-primary btn-sm'>删除</a>";
        btsStr += " </div>";
        btsStr += "</div>";
